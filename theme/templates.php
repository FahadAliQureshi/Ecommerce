...
<head>
  ...
  <link href="logoImageSize.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +9297136817</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> saihaEhsan786@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              ...
              <a class="logoImageSize href="<?php echo web_root?>"><img class="logoImageSize" src="images/home/mainLogoSahi.png" alt="" /></a>
            </div> 
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Saiha Ehsan</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Saiha Ehsan and Aleesha Haider</a></span></p>
        </div>
      </div>
    </div>
